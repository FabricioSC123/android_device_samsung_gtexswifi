...
git clone https://github.com/underscoremone/android_kernel_samsung_gtexswifi.git kernel/samsung/gtexswifi; git clone https://github.com/underscoremone/proprietary_vendor_samsung_gtexswifi.git vendor/samsung/gtexswifi
